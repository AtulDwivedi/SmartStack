...
<body>
	...
	<div class="container">
		...
		<div class="jumbotron">
			...
			<p class="pull-right">
				<a class="btn btn-default btn-primary" href="first.jsp"
					role="button">Questions</a> <a
					class="btn btn-default btn-primary disabled"
					href="../../components/#navbar" role="button">Tags</a>
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="col-md-3 well">
							<input type="button" class="btn btn-success btn-sm" value="C">
							x1000
							<hr>
							<p>You have to search for similar question. You have to
								search for similar question.</p>
						...
						<div class="col-md-3 well">
							<input type="button" class="btn btn-success btn-sm" value="OOP">
							x1000
							<hr>
							<p>You have to search for similar question. You have to
								search for similar question.</p>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="col-md-3 well">
							<input type="button" class="btn btn-success btn-sm" value="Java">
							x1000
							<hr>
							<p>You have to search for similar question. You have to
								search for similar question.</p>
						...
						<div class="col-md-3 well">
							<input type="button" class="btn btn-success btn-sm" value="JEE">
							x1000
							<hr>
							<p>You have to search for similar question. You have to
								search for similar question.</p>
						...
						<div class="col-md-3 well">
							<input type="button" class="btn btn-success btn-sm" value="OOD">
							x1000
							<hr>
							<p>You have to search for similar question. You have to
								search for similar question.</p>
